...
export default defineConfig({
  test: {
    ...
    exclude: ['**/node_modules/**', '**/dist/**', 'test/xauusd-m1m5/occupancy.spec.ts', 'test/xauusd-m1m5/execution.spec.ts', 'test/xauusd-m1m5/reconciliation.spec.ts', 'test/xauusd-m1m5/liquidation-reporting.spec.ts'],
    testTimeout: 20_000,
  },
  plugins: [
    swc.vite({
